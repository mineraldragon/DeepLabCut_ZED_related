...
def extract_xyz(x_pixel_M1, y_pixel_M1, x_pixel_M2, y_pixel_M2):
    x_world_M1 = []
    y_world_M1 = []
    z_world_M1 = []
    x_world_M2 = []
    ...
    filepath = "D:\\Data\\20191003\\20191003\\SVO_files\\20191003.svo"
    ...
    try:    
        ...
        with open('D:\\Data\\20191003\\20191003\\20191003_cage_coordinates.csv', 'w') as f:
            writer = csv.writer(f)
            for row in rows:
                writer.writerow(row)

if __name__ == "__main__":
    xy_filepath  = "D:\\Data\\20191003\\20191003\\will_tracker_files\\output\\20191003DeepCut_resnet50_reachingJan30shuffle1_200000.csv" 
    ...
    #x_pixel_M1, y_pixel_M1, x_pixel_M2, y_pixel_M2 = read_xy_mat(xy_filepath)
    x_pixel_M1head, y_pixel_M1head, x_pixel_M2head, y_pixel_M2head = read_xy_csv(xy_filepath)
    # extract_xyz(xy_M1, xy_M2)
    extract_xyz(x_pixel_M1head, y_pixel_M1head, x_pixel_M2head, y_pixel_M2head)